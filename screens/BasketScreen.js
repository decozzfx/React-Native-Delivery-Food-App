  ...
  return (
    <SafeAreaView className="flex-1 bg-white pt-9">
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b border-[#00CCBB]/30  bg-white shadow-lg">
          <View>
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
          ...
          <View className="flex-row justify-between">
            ...
            <Text className="text-gray-400">
              <Currency quantity={basketTotal * 0.1} currency="GBP" />
            </Text>
          </View>
          ...
          <View className="flex-row justify-between">
            ...
            <Text className="font-extrabold">
              <Currency
                quantity={basketTotal * 0.1 + basketTotal}
                currency="GBP"
              />
            </Text>
          </View>
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("PreparationOrderScreen")}
